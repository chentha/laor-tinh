...
@Component({
  selector: 'app-khqr',
  templateUrl: './khqr.component.html',
  styleUrls: ['./khqr.component.scss']
})
export class KhqrComponent {
  importData:any;
  constructor(private renderer: Renderer2, private el: ElementRef,
    ...
    console.log('data khqr', this.importData)
    // this.generateKHQR(this.importData)
  }

  ngOnInit(): void {
    setTimeout(() => {
      this.generateKHQR();
    }, 10000); // Delay of 500 milliseconds (half a second)
  }
  


  generateKHQR(KHQRString?: any) {
    ...
    this.renderer.setProperty(this.el.nativeElement.querySelector("#merc-name"), 'innerHTML', 'Chentha');
    this.renderer.setProperty(this.el.nativeElement.querySelector("#total-amount-khqr"), 'innerHTML', this.formatAmount(15, '840'));
    this.renderer.setProperty(this.el.nativeElement.querySelector("#currency"), 'innerHTML', '840');
    this.renderer.setProperty(this.el.nativeElement.querySelector("#currency-sign"), 'innerHTML', this.getCurrencySign('840'));
  }
