...
ngOnInit(){
  ...
  generateKHQR() {
    ...
    // const KHQRString = {
    //   bank_account: 'chentha_hour@aclb',
    //   merchant_name: 'Chentha Hour',
    //   merchant_city: 'Phnom Penh',
    //   amount: 1,
    //   currency: "KHR",
    //   store_label: 'Laor Tinh',
    //   phone_number: '0972999021',
    //   bill_number: 'TRX123456',
    //   terminal_label: 'POS-03' 
    // }

    // const encodedKHQR = KHQR.BakongKHQR.encode(KHQRString); // Make sure this returns a string
    // console.log('Encoded KHQR:', encodedKHQR);
    const KHQRString = '00020101021229600009khqr@ppcb011397000000239360226Phnom Penh Commercial Bank52045999530384054020015802KH5905VShop6010PHNOM PENH6228012400017020240521000008420199170013171628268728163047C9A'
    ...
    // const khqr = "00020101021229190015sothen_ban@wing520459995802KH5910Sothen Ban6010Phnom Penh991700131719988406104541100000008600530411772510109TRX12345602090123456780311Sothen SHOP0706POS-035304BC";
  ...
  encodeKHQR(data: any): string {
    ...
    const merchantAccountInfo = 
      format("00", "chentha_hour@aclb") +
      format("01", "0000") +
      format("02", "39360226Phnom Penh"); // Example bank
